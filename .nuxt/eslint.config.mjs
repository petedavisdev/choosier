...
import {
	...
	defineFlatConfigs,
	resolveOptions,
} from '../node_modules/@nuxt/eslint-config/dist/flat.mjs';
...
export const options = resolveOptions({
	...
	dirs: {
		...
		modules: ['modules'],
		servers: [],
		root: ['/Users/Pete/GitHub/choosier'],
		src: [''],
	},
});
	...
	// Set globals from imports registry
	{
		...
		languageOptions: {
			globals: {
				...
				Choice: 'readonly',
				useCover: 'readonly',
				useFilteredChoices: 'readonly',
				useProfile: 'readonly',
				PATHS: 'readonly',
				MIN_IMAGES: 'readonly',
				MAX_IMAGES: 'readonly',
				CATEGORIES: 'readonly',
				VISIBILITIES: 'readonly',
				Json: 'readonly',
				Database: 'readonly',
				Tables: 'readonly',
				TablesInsert: 'readonly',
				TablesUpdate: 'readonly',
				Enums: 'readonly',
				addDaysToISODate: 'readonly',
				longDateText: 'readonly',
				shortDateText: 'readonly',
				shuffle: 'readonly',
				windowHeightFix: 'readonly',
				useSupabaseClient: 'readonly',
				useSupabaseSession: 'readonly',
...
export function withNuxt(...customs) {
	return configs
		...
		.onResolved((configs) =>
			typegen(configs, {
				dtsPath: new URL('./eslint-typegen.d.ts', import.meta.url),

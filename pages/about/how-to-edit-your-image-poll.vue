<template>
	<Head>
		<Title>How to edit your image poll | Choosier</Title>
		<Meta
			name="description"
			content="After creating an image poll you can edit the title and category, close voting early or delete the poll."
		/>
	</Head>
	...
	<article>
		...
		<ul>
			<li>The title of the poll</li>
			<li>The category the poll is listed under</li>
		</ul>

		<p>
			If you want to change the images, you will need to delete your poll and
			create a new one.
		</p>
		<p>

<template>
	...
	<article>
		<h2>Personal data</h2>
		<p>
			Your email address will not be shared. It is only used for essential
			messages related to using Chooser. No emails will be sent to you without
			your permission.
		</p>
		...
		<p>
			...
			name and you can change it <LinkTo :to="PATHS.user">here</LinkTo>.
		</p>
	</article>
